...
voxel_engine.exe: src/main.cpp src/chunk.cpp src/player.cpp src/world.cpp src/menu.cpp src/renderer.cpp src/winxp_compat.cpp
	$(CXX) src/main.cpp src/chunk.cpp src/player.cpp src/world.cpp src/menu.cpp src/renderer.cpp src/winxp_compat.cpp -o voxel_engine.exe $(CXXFLAGS) $(LDFLAGS)
