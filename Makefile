...
voxel_engine.exe: src/main.cpp src/chunk.cpp src/chunk.h src/player.cpp src/player.h
	$(CXX) src/main.cpp src/chunk.cpp src/player.cpp -o voxel_engine.exe $(CXXFLAGS) $(LDFLAGS)
